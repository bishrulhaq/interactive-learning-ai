...
import { ArrowRight, BookOpen, Clock, FileText, Upload, Loader2, BarChart2 } from 'lucide-react'
      ...
      <main className="flex-1 container mx-auto px-4 py-8 space-y-12">
        ...
        <section className="text-center space-y-6 py-12">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Upload any PDF. Our AI tutor will generate lessons, flashcards, and quizzes specifically tailored to your material.
          </p>
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="rounded-full px-8 text-lg h-12 gap-2 shadow-lg hover:shadow-xl transition-all" asChild>
              <Link href="/upload">
        ...
        <div className="grid md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4">
            <Card className="h-full bg-blue-50 border-blue-100 shadow-sm hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription className="text-blue-600/80">Support for PDF documents</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Drag and drop your course materials, research papers, or textbooks to instantly generate study aids.
                </p>
                <Button variant="default" className="w-full bg-blue-600 hover:bg-blue-700 text-white border-0 shadow-none" asChild>
            ...
            <Card className="h-full shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-slate-800">
                  <Clock className="w-5 h-5 text-slate-500" /> Recent Documents
                </CardTitle>
                    ...
                    >
                      ...
                      <div className="overflow-hidden flex-1">
                        ...
                        <p className="text-xs text-slate-500 flex justify-between mt-1">
                          ...
                          <span className="capitalize text-blue-600">{doc.status}</span>
                        </p>
                      </div>
          ...
          <div className="md:col-span-4">
            <Card className="h-full shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-slate-800">
                  <BarChart2 className="w-5 h-5 text-green-600" /> Stats
                </CardTitle>
              ...
              <CardContent className="grid grid-cols-2 gap-4 text-center">
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest mt-1">Documents</p>
                </div>
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                  <p className="text-3xl font-bold text-slate-800">{stats.quizzes}</p>
                  <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest mt-1">Quizzes Generated</p>
                </div>
              </CardContent>
            </Card>
          </div>
