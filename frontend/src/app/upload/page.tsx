        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-4">
            <div className="w-full max-w-xl text-center space-y-8">
                <div className="space-y-2">
                    <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl">Upload Document</h1>
                    <p className="text-muted-foreground text-lg">Start by uploading a PDF textbook or article.</p>
                </div>
                ...
                <div
                    ...
                    className={cn(
                        ...
                        isDragActive ? "border-blue-500 bg-blue-50 ring-2 ring-blue-200" : "border-slate-200 hover:border-blue-400",
