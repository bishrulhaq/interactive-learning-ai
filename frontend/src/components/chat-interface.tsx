            ...
            <ScrollArea className="flex-1 p-4 min-h-0">
                <div className="space-y-4 max-w-3xl mx-auto">
                    {messages.map((msg, i) => (
                        ...
                        >
                            <Avatar className={cn("w-8 h-8", msg.role === 'assistant' ? "bg-blue-100" : "bg-slate-200")}>
                                <AvatarFallback>
                                    {msg.role === 'assistant' ? <Bot className="w-5 h-5 text-blue-600" /> : <User className="w-5 h-5 text-slate-600" />}
                                </AvatarFallback>
                            </Avatar>
